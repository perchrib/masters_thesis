...
def stopwords_detect_and_print(text):
...
def detect_languages_and_print(text):
    ENGLISH = 'en'
    SPANISH = 'es'
    ...
    try:
        ...
        # if ENGLISH not in confidences:
        #     print(text)
        # elif confidences[ENGLISH] < 0.1:
        #     print(text)

        if SPANISH in confidences and confidences[SPANISH] > 0.1:
            print(text)
        return confidences
